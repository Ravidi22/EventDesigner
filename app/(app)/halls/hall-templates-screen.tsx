...
//
// NOT ROUTED. This was `/halls` until the venue plan editor (halls-screen.tsx) took that route:
// a zone is an identifier over the venue's one shared wall graph, which is the model that replaces
// "a hall is its own drawing starting at (0,0)". It is kept intact, and reachable in one import,
// because HallTemplate is still what the meeting flow and the Gantt actually read — until events
// carry `zoneIds`, this is the only UI that can create or edit one. Route it back (or give it a
// tab) if a hall shell needs editing before that migration lands.
export function HallTemplatesScreen() {
