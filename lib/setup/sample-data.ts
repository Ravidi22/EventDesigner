...
export const SEED_TEMPLATES: HallTemplate[] = [
  {
    ...
    hall: {
      ...
      columns: [{ x: 6500, y: 6500, rMm: 350 }, { x: 13500, y: 6500, rMm: 350 }],
      entrances: [{ id: "ent-1", wallIndex: 2, distanceMm: 10000, widthMm: 1800, swingInward: true, doubleDoor: true }],
      stage: { id: "fx-stage", label: "במה", x: 10000, y: 1600, widthMm: 6000, depthMm: 2400, heightMm: 600, shape: "rect", rotationDeg: 0 },
      bars: [],
    },
    mmPerUnit: 1,
  ...
  },
  {
    ...
    hall: {
      ...
      columns: [],
      entrances: [{ id: "ent-1", wallIndex: 0, distanceMm: 4000, widthMm: 2400, swingInward: true, doubleDoor: true }],
      bars: [{ id: "fx-bar", label: "בר", x: 22000, y: 3000, widthMm: 2200, depthMm: 2200, heightMm: 1100, shape: "circle", rotationDeg: 0 }],
    },
    mmPerUnit: 1,
