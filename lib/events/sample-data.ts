...
// - noa-itai + yael-bat also carry a meetingDate on today's sample "now" — one consultation
//   per hall within venue-ronit, so Today's Focus's "פגישות" tab has something real to show,
//   across the venue's two halls, without touching the event date itself.
import type { EventSummary } from "./types";

export const SAMPLE_EVENTS: EventSummary[] = [
  { id: "ev-noa-itai", clientName: "נועה ואיתי", phone: "052-1234567", date: "2026-08-14", meetingDate: "2026-07-31", hallTemplateId: "hall-ronit-big", hallName: "אולם גדול", guests: 240, step: 5, createdAt: Date.parse("2026-06-20") },
